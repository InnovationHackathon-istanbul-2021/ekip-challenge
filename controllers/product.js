...
const getProducts = async (request, response) => {
    ...
    if (products.length > 0) {
        response.status(200).render("dashboard/product", {products: products});
    } else {
...
const updateProduct = async (req, res) => {
    ...
    if (product) {
        ...
        res.status(200).render("dashboard/edit-products", {product: product});
    } else {
